...
# ==========================================
# 1. CẤU HÌNH BIẾN MÔI TRƯỜNG TỪ RENDER
# ==========================================
...
if not APP_ID or not APP_SECRET:
    print("CANH BAO: Chua thay LARK_APP_ID hoac LARK_APP_SECRET trong Environment cua Render.")

client = lark.Client.builder().app_id(APP_ID).app_secret(APP_SECRET).log_level(lark.LogLevel.INFO).build()

# ==========================================
# 2. HTTP SERVER GIỮ SỐNG RENDER WEBSERVICE
# ==========================================
...
# ==========================================
# 3. HÀM TIỆN ÍCH GỬI TIN NHẮN & BÓC TÁCH
# ==========================================
...
def extract_clean_text(message_dict: dict):
    ...
    Xử lý trơn tru cả tin nhắn 'text' thông thường lẫn tin nhắn 'post' (Rich Text khi có @mention).
    """
...
def handle_menu_click(data: dict):
    ...
    print(f"Da bam nut Menu: key='{event_key}', open_id='{open_id}'")
...
def handle_message_receive(data: dict):
    ...
    print(f"Nhan tin nhan [{chat_type}]: {clean_text}")
